...
public class Messages {
    ...
    public static void setupMessages() {
        for (Language l : Language.getLanguages()) {
            ...
            addDefault(l, CHOICE_LORE, Arrays.asList("&7Click to join the", "{color}{team} Team&7.", "", "&7Current players:", "&7&o{members}", "", "&eClick to join!"), Arrays.asList("", "&7&o{members}", "", "&eIntra cu Click!"));
            addDefault(l, CHOICE_NAME, "{color}{team} TEAM &f({selected}&7/&f{total})", "{color}{team} &f({selected}&7/&f{total})");
